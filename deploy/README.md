...
The current deployment is a local synthetic-instrument prototype. It has no remote authentication, multi-user isolation, external device access, guaranteed latency, high availability or certified measurement behavior. Supported external adapters use separately bound scientific runtimes as documented in the instrument catalogue.
