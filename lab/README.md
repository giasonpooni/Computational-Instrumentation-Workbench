...
queue described in [docs/LAB.md](../docs/LAB.md) once a reviewed run is
committed; until then it holds only this file, and `scripts/check_lab.py`
refuses to compare against it. The run is generated by
