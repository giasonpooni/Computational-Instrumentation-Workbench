...
substrate: it links twenty-one retained workflows to measurement/state/covariance and
...
supports twenty-one executable source kinds and source-only geography; it is not an arbitrary bundle
