...
substrate: it links twenty-two retained workflows to measurement/state/covariance and
...
supports twenty-two executable source kinds and source-only geography; it is not an arbitrary bundle
