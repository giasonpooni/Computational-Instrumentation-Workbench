...
| Calibration contract and deterministic bench | Calibration profile and its record, raw immutability, corrected channels as derived result channels, calibration state, profile refusal, deterministic fixture set, bench report and metric set, physical-bench declarations, execution placement, replay from local files | CIW-CAL-001, CIW-CAL-002, CIW-CAL-003, CIW-CAL-004, CIW-CAL-005, CIW-CAL-006, CIW-CAL-007, CIW-CAL-008, CIW-CAL-009, CIW-CAL-010, CIW-CAL-011 | M1; M2 (in-session corrected run CIW-CAL-002, digest re-verification CIW-CAL-011); M3 (physical bench CIW-CAL-009, real-instrument replay CIW-CAL-011); M5 (late fixture classes CIW-CAL-006) |
...
```json
{
  ...
  "verification_status": "not_verified",
  "status": "complete",
  "calibration": {"state": "uncalibrated", "profile_result_id": null, "profile_digest": null,
                  "applied_at": null, "valid_until": null},
  "calibration_profile": {
