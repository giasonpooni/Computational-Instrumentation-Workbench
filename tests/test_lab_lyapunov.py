...
def test_t107_inconclusive_band(reports, provider_run):
    ...
    # the BLAS kernel's last bits move its points and its axis range. It is declared a rounding-level figure.
    points = json.loads((provider_run / "artifacts" / "T107" / "inconclusive-band.json").read_text(
...
def test_t109_adversarial_eigenvalues(reports, provider_run):
    ...
    # declared a rounding-level figure.
